        ...
        <li class="list-group-item">
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-8">
                        <a href="http://localhost/qwe/show.php?id=<?= $box['boxId'] ?>" class="btn btn-outline-success btn-sm">Show</a>
                        <a href="http://localhost/qwe/edit.php?id=<?= $box['boxId'] ?>" class="btn btn-outline-info btn-sm">Edit</a>
                        <a href="http://localhost/qwe/delete.php?id=<?= $box['boxId'] ?>" class="btn btn-outline-danger btn-sm">Delete</a>
                    </div>
                </div>
            </div>
        </li>
